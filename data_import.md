...
check out "?read\_csv() for more information. - put command into console
...
what about ‘read.csv’ …? read.csv is built into r more difficult to look
at printed difference between base and readr = most obvious difference
never use read.csv always use read\_csv
